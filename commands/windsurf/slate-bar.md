...
3. **Place `<div id="slate-preview"></div>` at the exact location the user wants variants to appear** (see below).
4. If placement or cohesionContext are missing, ask the user and add them.
